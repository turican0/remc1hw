	...
	if (debugafterload)
	{
		...
		if (index >= skip2)
		{
			if (index >= stopstep)
			{
				...
				if (!skip)
				{
					//fix comp20 = compare_with_sequence(buffer1, (uint8_t*)mapTerrainType_CC1E0, 0x28A1E0, index - skip2, 0x70000, 0x10000, &origbyte20, &remakebyte20, 0, (exitindex != 1000000));
					//fix comp20 = compare_with_sequence(buffer1, (uint8_t*)mapHeightmap_DC1E0, 0x28A1E0, index - skip2, 0x70000, 0x10000, &origbyte20, &remakebyte20, 0x10000, (exitindex != 1000000));
					//fix comp20 = compare_with_sequence(buffer1, (uint8_t*)mapShading_EC1E0, 0x28A1E0, index - skip2, 0x70000, 0x10000, &origbyte20, &remakebyte20, 0x20000, (exitindex != 1000000));
					//fix comp20 = compare_with_sequence(buffer1, (uint8_t*)mapAngle_FC1E0, 0x28A1E0, index - skip2, 0x70000, 0x10000, &origbyte20, &remakebyte20, 0x30000, (exitindex != 1000000));
